...
This section does not cover consumer API, but focuses only on internal algorithms implemented in tabulate-core module. You won't find information needed to start using library. Refer to below information only If you are curious about how things work under the hood.

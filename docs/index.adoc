...
It is crucial to mention that *explicitly changed* cited above means that only attribute properties changed by explicit builder method cat are considered.

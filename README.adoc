...
<2> sheet will consist of columns each containing object property values extracted by property literals.
<3> column widths will be automatically adjusted to cell value lengths.

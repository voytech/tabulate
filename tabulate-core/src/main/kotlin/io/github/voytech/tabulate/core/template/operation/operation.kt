...
fun <CTX : RenderingContext, ATTR_CAT : Attribute<*>, E : AttributedModel<ATTR_CAT>>
        Class<out Operation<CTX,ATTR_CAT,E>>.noop(): Operation<CTX,ATTR_CAT,E>  = Operation<CTX,ATTR_CAT,E> {_,_ -> }
 ...
 * @since 0.1.0
 */
interface AttributeOperation<CTX : RenderingContext, ARM : Model, ATTR_CAT : Attribute<*>, ATTR : ATTR_CAT, E : AttributedModel<ATTR_CAT>> {
...
abstract class AbstractAttributeOperation<
        ...
        ATTR_CAT : Attribute<*>,
        ATTR : ATTR_CAT,
        E : AttributedModel<ATTR_CAT>> :  AttributeOperation<CTX, ARM, ATTR_CAT, ATTR, E>{
...
fun <CTX : RenderingContext,
        ARM : Model,
        ATTR_CAT : Attribute<*>,
        ATTR : ATTR_CAT,
        E : AttributedModel<ATTR_CAT>> AttributeOperation<CTX, ARM, ATTR_CAT, ATTR, E>.attributeClass() =
...
data class Operations<CTX : RenderingContext>(
    ...
    fun <E : AttributedModel<*>> render(renderingContext: CTX, context: E) {
...
class OperationsBuilder<CTX : RenderingContext, ARM : Model>(
    ...
    fun <ATTR_CAT : Attribute<*>, E : AttributedModel<ATTR_CAT>> operation(
    ...
    inline fun <reified ATTR_CAT : Attribute<*>, reified E : AttributedModel<ATTR_CAT>> operation(op: Operation<CTX, ATTR_CAT, E>) {

...
data class AttributeClassifier<CAT: Attribute<*>,ARM: Model>(
    val attributeCategory: Class<CAT>,
    val rootModel: Class<ARM>
) {
    companion object {
        inline fun <reified CAT: Attribute<*>, reified ARM: Model> classify() =
...
inline fun <reified CAT: Attribute<*>, ARM: Model> Class<CAT>.classifyUnder(rootModel: Class<ARM>) =
    AttributeClassifier(CAT::class.java,rootModel)

inline fun <CAT: Attribute<*>, reified ARM: Model> Class<ARM>.classifyWith(category: Class<CAT>) =
